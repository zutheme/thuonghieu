...
/**
*
* Adapted from Edward McIntyre's wp_bootstrap_navwalker_page class. 
* Removed support for glyphicon and added support for Font Awesome
*
*/
/**
 * Class Name: wp_bootstrap_navwalker_page
...
class wp_bootstrap_navwalker_page extends Walker_Nav_Menu {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			*/
			...
			if ( $args->has_children ) {
				...
				$atts['class']			= 'dropdown-toggle dropdown-submenu-link';
			} else {
	 ...
	 *
	 */
	public static function fallback_page( $args ) {
