...
function startGame() {
  ...
  //noel_ride = new component(390, 208,  urlblog + "/game/images/xe-tuan-loc.png", 100, 100, "image");
  //noel_ride = new component(390, 208,  urlblog + "/game/images/sant01.png", 0, 0, "image","gravity");
  myObstacles = []; 
  ...
  myGameArea.speedY = 0.9;
  //console.log(myGameArea.canvas.height);
  //myGameArea.gravitySpeed = 0.1;
}
...
function updateGameArea() {  
  ...
  for (i = 0; i < myObstacles.length; i += 1) {
    ...
    //console.log(myGameArea.timeinterval,myGameArea.gravitySpeed,myGameArea.speedY);
    myBackground.newPos();    
    ...
    if (myGameArea.frameNo == 1 || everyinterval(myGameArea.timeinterval)) {
        ...
        myObstacles.push(new component(gap, gap,  urlblog + "/game/images/gift_box1.png", x, 0, "image"));
    ...
    for (i = 0; i < myObstacles.length; i += 1) {
      ...
      //console.log(myObstacles[i].speedY);
