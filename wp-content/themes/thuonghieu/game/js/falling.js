...
function startGame() {
  ...
  //txt_coordinate = new component(_font_myScore, "Consolas", "black", (_width_screen/2)-50, 60, "text");
...
function updateGameArea() {  
  ...
  for (i = 0; i < myObstacles.length; i += 1) {
    ...
    myScore.text = "Nhận:" + myGameArea.score+ " Mất:"+ myGameArea.failed+' Lượt:'+ count +" Còn:"+Math.floor((myGameArea.timeEnd - myGameArea.frameNo)/50)+'s';
    myScore.update();
    // if(myGameArea.mouse_clicked){
    //   txt_coordinate.text = 'x:'+myGameArea.x+' y:'+myGameArea.y;
    //   txt_coordinate.update();
    // }
}
