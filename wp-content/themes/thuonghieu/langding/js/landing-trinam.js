...
document.addEventListener('DOMContentLoaded', (event) => {
  ...
  var _e_experience_form = document.getElementsByClassName('frm-experience')[0];



  var e_btn_reg_experience = _e_experience_form.getElementsByClassName('btn-reg-survey')[0];



  e_btn_reg_experience.addEventListener("click", reg_experience);



  function reg_experience(){
    ...
    var _efullname = _e_experience_form.getElementsByClassName('fullname')[0];
    ...
    var _ephone = _e_experience_form.getElementsByClassName('phone')[0];

    //var _e_email = _e_experience_form.getElementsByClassName('email')[0];

    //var _email = _e_email.value;
    var _email = '';
    //var name_sevice = getSelectedText('select-service');

    var _ecomment = _e_experience_form.getElementsByClassName('comment')[0];

    var _comment = _ecomment.value;
...
//var vnf_regex = /((09|03|07|08|05)+([0-9]{8})\b)/g;
    ...
    var load = _e_experience_form.getElementsByClassName("loading")[0];
    ...
    var e_result = _e_experience_form.getElementsByClassName("result")[0];
