...
document.addEventListener('DOMContentLoaded', (event) => {
	...
	function reg_consultant(){
	  ...
	  var params = JSON.stringify({firstname: _firstname, mobile: _mobile, email:'' ,address:'', namecat: _namecat, body:_body, typepost:_typepost, name_status_type:_name_status_type,orfilename:'', file:gbdataURL });
